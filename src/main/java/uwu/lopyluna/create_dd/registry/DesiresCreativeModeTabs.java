	...
	private static class RegistrateDisplayItemsGenerator implements CreativeModeTab.DisplayItemsGenerator {
        ...
        private static Predicate<Item> makePaletteInclusionPredicate() {
            ...
            List<ItemProviderEntry<?>> simplePaletteInclusions = List.of(
                    ...
                    DesiresPaletteBlocks.WHITE_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.LIGHT_GRAY_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.GRAY_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.BLACK_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.BROWN_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.RED_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.ORANGE_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.YELLOW_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.LIME_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.GREEN_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.CYAN_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.LIGHT_BLUE_BLUEPRINT_CARPET,
                    DesiresPaletteBlocks.BLUE_BLUEPRINT_CARPET,
