...
public class DesiresPartialModels {
	...
	public static final PartialModel
        ...
        SHADOW_SAW_BLADE_HORIZONTAL_ACTIVE = block("radiant_saw/blade_horizontal_active"),
        SHADOW_SAW_BLADE_HORIZONTAL_INACTIVE = block("radiant_saw/blade_horizontal_inactive"),
        SHADOW_SAW_BLADE_HORIZONTAL_REVERSED = block("radiant_saw/blade_horizontal_reversed"),
        SHADOW_SAW_BLADE_VERTICAL_ACTIVE = block("radiant_saw/blade_vertical_active"),
        SHADOW_SAW_BLADE_VERTICAL_INACTIVE = block("radiant_saw/blade_vertical_inactive"),
        SHADOW_SAW_BLADE_VERTICAL_REVERSED = block("radiant_saw/blade_vertical_reversed"),
