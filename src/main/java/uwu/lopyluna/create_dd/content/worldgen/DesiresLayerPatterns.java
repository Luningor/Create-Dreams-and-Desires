...
public class DesiresLayerPatterns {
    ...
    public static final NonNullSupplier<LayerPattern> CASSITERITE = () -> LayerPattern.builder()
            .layer(l -> l.weight(2)
                    .block(DesiresPaletteStoneTypes.POTASSIC.getBaseBlock())
                    .size(2, 5))
            .layer(l -> l.weight(1)
            ...
            .layer(l -> l.weight(1)
                    ...
                    .size(2, 2))
            .layer(l -> l.weight(1)
                    .block(DesiresPaletteStoneTypes.WEATHERED_LIMESTONE.getBaseBlock())
                    .size(1, 2))
            .build();

    public static final NonNullSupplier<LayerPattern> GABBRO = () -> LayerPattern.builder()
            .layer(l -> l.weight(2)
                    .block(DesiresPaletteStoneTypes.GABBRO.getBaseBlock())
                    .size(2, 3))
            .layer(l -> l.weight(1)
    ...
    public static final NonNullSupplier<LayerPattern> RAW_CASSITERITE = () -> LayerPattern.builder()
            .layer(l -> l.weight(2)
                    .blocks(DesiresBlocks.TIN_ORE.get(), DesiresBlocks.DEEPSLATE_TIN_ORE.get())
                    .size(1, 3))
            .layer(l -> l.weight(1)
                    .block(Blocks.DIORITE)
                    .block(Blocks.DEEPSLATE)
