...
public class DesiresPlacedFeatures {
    ...
    private static ResourceKey<PlacedFeature> key(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, DesiresCreate.asResource(name));
    }

    public static void bootstrap(BootstapContext<PlacedFeature> ctx) {
        HolderGetter<ConfiguredFeature<?, ?>> featureLookup = ctx.lookup(Registries.CONFIGURED_FEATURE);
        Holder<ConfiguredFeature<?, ?>> tin_ore = featureLookup.getOrThrow(DesiresConfiguredFeatures.TIN_ORE);
        Holder<ConfiguredFeature<?, ?>> gabbro_blob = featureLookup.getOrThrow(DesiresConfiguredFeatures.GABBRO_BLOB);
        Holder<ConfiguredFeature<?, ?>> striated_ores_overworld = featureLookup.getOrThrow(DesiresConfiguredFeatures.STRIATED_ORES_OVERWORLD);
        Holder<ConfiguredFeature<?, ?>> striated_ores_savanna = featureLookup.getOrThrow(DesiresConfiguredFeatures.STRIATED_ORES_SAVANNA);
        Holder<ConfiguredFeature<?, ?>> striated_ores_badlands = featureLookup.getOrThrow(DesiresConfiguredFeatures.STRIATED_ORES_BADLANDS);
        Holder<ConfiguredFeature<?, ?>> striated_ores_ocean = featureLookup.getOrThrow(DesiresConfiguredFeatures.STRIATED_ORES_OCEAN);
        Holder<ConfiguredFeature<?, ?>> striated_raw_ores_overworld = featureLookup.getOrThrow(DesiresConfiguredFeatures.STRIATED_RAW_ORES_OVERWORLD);
    ...
    private static List<PlacementModifier> placement(PlacementModifier frequency, int minHeight, int maxHeight) {
        return List.of(
                ...
                DesiresConfigPlacementFilter.INSTANCE
        );
    }
}