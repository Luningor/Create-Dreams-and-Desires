...
public class RadiantDrillActorVisual extends ActorVisual {
    ...
    public RadiantDrillActorVisual(VisualizationContext visualizationContext, VirtualRenderWorld contraption, MovementContext context) {
        ...
        drillHead = instancerProvider.instancer(InstanceTypes.TRANSFORMED, Models.partial(DesiresPartialModels.RADIANT_DRILL_HEAD))
                .createInstance();
    }
