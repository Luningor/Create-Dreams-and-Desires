...
public class PotatoTripleItemHandler extends ItemStackHandler {
    public TriplePotatoTurretBlockEntity be;
    @Nullable public ServerLevel level;
    public PotatoTripleItemHandler(TriplePotatoTurretBlockEntity be) {
        super(1);
        this.be = be;
    }
