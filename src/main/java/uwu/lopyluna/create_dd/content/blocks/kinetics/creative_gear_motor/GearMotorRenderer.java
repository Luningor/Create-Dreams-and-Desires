...
public class GearMotorRenderer extends KineticBlockEntityRenderer<CreativeGearMotorBlockEntity> {
    public GearMotorRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected SuperByteBuffer getRotatedModel(CreativeGearMotorBlockEntity be, BlockState state) {
