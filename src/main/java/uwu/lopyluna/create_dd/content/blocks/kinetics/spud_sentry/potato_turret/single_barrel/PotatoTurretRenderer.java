...
public class PotatoTurretRenderer extends KineticBlockEntityRenderer<PotatoTurretBlockEntity> {
    ...
    @Override
    protected void renderSafe(PotatoTurretBlockEntity be, float pt, PoseStack ms, MultiBufferSource buffer, int light, int overlay) {
        ...
        SuperByteBuffer cannon = CachedBuffers.partial(DesiresPartialModels.POTATO_TURRET_SINGLE_BARREL, state)
                .light(light);
