...
public class TwoBladeFanBlockVisual extends KineticBlockEntityVisual<TwoBladeFanBlockEntity> implements SimpleDynamicVisual {
    ...
    public TwoBladeFanBlockVisual(VisualizationContext context, TwoBladeFanBlockEntity blockEntity, float partialTick) {
        ...
        wheel = instancerProvider().instancer(InstanceTypes.TRANSFORMED, Models.partial(DesiresPartialModels.TWO_BLADE_FAN))
                .createInstance();
