...
public class PotatoDualItemHandler extends ItemStackHandler {
    public DualPotatoTurretBlockEntity be;
    @Nullable public ServerLevel level;
    public PotatoDualItemHandler(DualPotatoTurretBlockEntity be) {
        super(1);
        this.be = be;
    }
