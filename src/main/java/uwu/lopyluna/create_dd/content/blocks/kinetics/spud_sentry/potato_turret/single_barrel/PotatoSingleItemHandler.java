...
public class PotatoSingleItemHandler extends ItemStackHandler {
    public PotatoTurretBlockEntity be;
    @Nullable public ServerLevel level;
    public PotatoSingleItemHandler(PotatoTurretBlockEntity be) {
        super(1);
        this.be = be;
    }
