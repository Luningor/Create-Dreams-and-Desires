...
public class OmniGearboxRenderer extends KineticBlockEntityRenderer<OmniGearboxBlockEntity> {
    public OmniGearboxRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(OmniGearboxBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer, int light, int overlay) {
