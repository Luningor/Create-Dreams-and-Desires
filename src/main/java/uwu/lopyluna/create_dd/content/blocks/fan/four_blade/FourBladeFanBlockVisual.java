...
public class FourBladeFanBlockVisual extends KineticBlockEntityVisual<FourBladeFanBlockEntity> implements SimpleDynamicVisual {
    ...
    public FourBladeFanBlockVisual(VisualizationContext context, FourBladeFanBlockEntity blockEntity, float partialTick) {
        ...
        wheel = instancerProvider().instancer(InstanceTypes.TRANSFORMED, Models.partial(DesiresPartialModels.FOUR_BLADE_FAN))
                .createInstance();
