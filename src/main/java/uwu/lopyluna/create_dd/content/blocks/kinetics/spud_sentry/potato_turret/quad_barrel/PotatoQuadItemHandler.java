...
public class PotatoQuadItemHandler extends ItemStackHandler {
    public QuadPotatoTurretBlockEntity be;
    @Nullable public ServerLevel level;
    public PotatoQuadItemHandler(QuadPotatoTurretBlockEntity be) {
        super(1);
        this.be = be;
    }
