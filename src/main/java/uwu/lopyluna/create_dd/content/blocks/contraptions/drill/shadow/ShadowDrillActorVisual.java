...
public class ShadowDrillActorVisual extends ActorVisual {
    ...
    public ShadowDrillActorVisual(VisualizationContext visualizationContext, VirtualRenderWorld contraption, MovementContext context) {
