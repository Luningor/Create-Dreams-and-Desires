package uwu.lopyluna.create_dd.content.blocks.magic;
...
public class BlazeGoldBlockcasing extends CasingBlock {

    public BlazeGoldBlockcasing(Properties pProperties) {
        super(pProperties);
    }
