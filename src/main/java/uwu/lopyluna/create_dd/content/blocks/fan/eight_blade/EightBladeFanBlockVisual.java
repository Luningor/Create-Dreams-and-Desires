...
public class EightBladeFanBlockVisual extends KineticBlockEntityVisual<EightBladeFanBlockEntity> implements SimpleDynamicVisual {
    ...
    public EightBladeFanBlockVisual(VisualizationContext context, EightBladeFanBlockEntity blockEntity, float partialTick) {
        ...
        wheel = instancerProvider().instancer(InstanceTypes.TRANSFORMED, Models.partial(DesiresPartialModels.EIGHT_BLADE_FAN))
                .createInstance();
