...
public class SpudSentryRenderer extends KineticBlockEntityRenderer<SpudSentryBlockEntity> {
    public SpudSentryRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(SpudSentryBlockEntity be, float pt, PoseStack ms, MultiBufferSource buffer, int light, int overlay) {
    ...
    @Override
    protected SuperByteBuffer getRotatedModel(SpudSentryBlockEntity be, BlockState state) {
