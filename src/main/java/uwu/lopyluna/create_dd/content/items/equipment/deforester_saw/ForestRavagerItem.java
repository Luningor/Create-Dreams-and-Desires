...
public class ForestRavagerItem extends BackTankAxeItem {
    ...
    public static void onBlockDestroyed(BlockEvent.BreakEvent event) {
        ...
        if (!DesiresItems.FOREST_RAVAGER.isIn(heldItemMainhand))
            return;
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(SimpleCustomRenderer.create(this, new ForestRavagerRenderer()));
    }
