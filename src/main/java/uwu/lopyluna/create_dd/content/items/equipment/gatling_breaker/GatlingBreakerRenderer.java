package uwu.lopyluna.create_dd.content.items.equipment.gatling_breaker;
...
public class GatlingBreakerRenderer extends CustomRenderedItemModelRenderer {
    protected static final PartialModel CORE = PartialModel.of(DesiresCreate.asResource("item/gatling_breaker/core"));
    protected static final PartialModel CORE_GLOW = PartialModel.of(DesiresCreate.asResource("item/gatling_breaker/core_glow"));
    protected static final PartialModel GEAR = PartialModel.of(DesiresCreate.asResource("item/gatling_breaker/gear"));
