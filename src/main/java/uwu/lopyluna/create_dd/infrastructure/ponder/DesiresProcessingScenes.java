...
public class DesiresProcessingScenes {


    public static void industrialFanSource(SceneBuilder builder, SceneBuildingUtil util) {
    ...
    public static void motors(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
        ...
        scene.overlay().showControls(util.vector().topOf(0, 0, 0), Pointing.DOWN, 60).rightClick();
        scene.idle(20);
    ...
    public static void cogCrank(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
        ...
        scene.overlay().showControls(util.vector().topOf(0, 0, 0), Pointing.DOWN, 60).rightClick().whileSneaking();
        scene.idle(7);
        scene.world().setKineticSpeed(util.select().position(handlePos), -32);
        scene.world().setKineticSpeed(util.select().fromTo(pos1, gaugePos), 16);
        scene.effects().rotationDirectionIndicator(handlePos);
    ...
    public static void fanSails(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
    ...
    public static void stoneGeneration(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
    ...
    public static void furnaceEngine(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
    ...
    private static void furnaceEngine(SceneBuilder builder, SceneBuildingUtil util, boolean flywheel) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
        ...
        scene.addKeyframe();
        scene.overlay().showControls(util.vector().topOf(furnacePos), Pointing.DOWN, 30).withItem(new ItemStack(Items.OAK_LOG));
        scene.idle(5);
        scene.overlay().showControls(util.vector().blockSurface(furnacePos, Direction.NORTH), Pointing.RIGHT, 30).withItem(new ItemStack(Items.COAL));
        scene.idle(7);
        scene.world().cycleBlockProperty(furnacePos, FurnaceBlock.LIT);
        scene.effects().emitParticles(util.vector().of(4.5, 2.2, 2.9), scene.effects().simpleParticleEmitter(ParticleTypes.LAVA, Vec3.ZERO), 4, 1);
